...
app.get('/withings/activity/weight', function (req, res) {
    ...
    client.getWeightMeasures(new Date(2013, 5, 1), new Date(),function(err, data) {
        ...
        html += "<div style='width:90%;background-color:#d8d8d8;margin-left:5%;margin-top:20px'><h1 style='font-family:Helvetica;font-size:42px;margin-top:15px;margin-left:15px'>Votre poids :</h1> <ul style='font-size:20px;font-family:Arial'>";
